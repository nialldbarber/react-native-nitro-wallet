...
namespace margelo::nitro::nitrowallet::bridge::swift {
  ...
  /**
   * Specialized version of `std::shared_ptr<margelo::nitro::nitrowallet::HybridNitroWalletSpec>`.
   */
  using std__shared_ptr_margelo__nitro__nitrowallet__HybridNitroWalletSpec_ = std::shared_ptr<margelo::nitro::nitrowallet::HybridNitroWalletSpec>;
  ...
  // pragma MARK: std::weak_ptr<margelo::nitro::nitrowallet::HybridNitroWalletSpec>
